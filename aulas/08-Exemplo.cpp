...
void loadBMP(char* filename) {
  ...
  glGenTextures(1, &idTextura); //definindo um id para a textura
  glBindTexture(GL_TEXTURE_2D, idTextura); //escolhendo a textura com idTextura para uso
...
void drawTriangle() {
  ...
  glColor3f(0, 1, 0);
  glTexCoord2f(0.0f, 0.0f); //coordenada uv (uvw) para o ponto abaixo
